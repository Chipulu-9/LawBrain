...
export function LandingPage() {
  ...
  return (
    <>
      ...
      ══════════════════════════════════════════ */}
        <section
          className={`relative overflow-hidden parchment-pattern ${user ? 'pt-20 pb-24 md:pt-28 md:pb-32' : 'min-h-[calc(100vh-4rem)] flex items-center'}`}
        >
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
            ...
            <p className="text-lg sm:text-xl text-brown-600 max-w-2xl mx-auto leading-relaxed mb-12">
              ...
              Every answer is grounded in official legal documents with cited references you can
              verify.
            </p>
              ...
              <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="text-center mb-14">
                  ...
                  <p className="text-brown-600 max-w-xl mx-auto text-base">
                    Combining the precision of a legal library with the accessibility of a
                    conversation.
                  </p>
                </div>
                    ...
                    <div className="bg-brown-50 border border-brown-200 rounded-2xl shadow-xl p-6 space-y-4">
                      ...
                      <div className="flex gap-3">
                        ...
                        <div className="bg-white border border-brown-200 rounded-2xl rounded-tl-sm px-4 py-3 text-sm text-brown-800 leading-relaxed shadow-sm max-w-[85%]">
                          <p className="mb-2">
                            Under <strong>Article 18 of the Constitution of Zambia</strong>, every
                            person charged with a criminal offence has the right to:
                          </p>
            ...
            <section id="corpus" className="py-20 md:py-28 bg-brown-50">
              <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
                ...
                <p className="text-brown-600 max-w-xl mx-auto mb-12">
                  LawBrain's knowledge base is built from official, government-published legal
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
                  {[
                    {
                      title: 'Constitution of Zambia',
                      sections: '128 Articles',
                      type: 'Constitution',
                    },
                    {
                    ...
                    {
                      title: 'Zambia Institute of Diplomacy Act',
                      sections: '42 sections',
                      type: 'Act',
                    },
                    {
                      title: 'More Acts — Coming Soon',
            ...
            <section className="brown-gradient py-20 md:py-24">
              <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  ...
                  <a
                    href="#corpus"
                    className="inline-flex items-center gap-2 px-8 py-4 bg-transparent text-white border border-brown-500 font-medium text-sm rounded-xl hover:bg-brown-700 transition-all duration-200 cursor-pointer outline-none focus:outline-none focus-visible:ring-2 focus-visible:ring-brown-400 focus-visible:ring-offset-2 active:scale-95"

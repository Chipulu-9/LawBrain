        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm leading-relaxed text-brown-400 max-w-xs">
              AI-powered legal assistant grounded in the Laws of Zambia. Every answer is cited and
              traceable to official government documents.
            </p>
            <div className="flex items-center gap-4 mt-5">
              <a
                href="#"
                aria-label="GitHub"
                className="text-brown-500 hover:text-brown-200 transition-colors"
